...
'ушах, сильная одышка и др.), то тст необходимо прервать и обратиться к врачу')
txt_title = 'Здоровье'
